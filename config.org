...
*** Org capture
    #+begin_src emacs-lisp :tangle yes
      ...
      (defun d4g-close-frame-after-org-capture ()
        (if (frame-parameter nil 'd4g-close-frame-after-org-capture)
            (delete-frame)))
      (add-hook 'org-capture-after-finalize-hook 'd4g-close-frame-after-org-capture)
